...
Return ONLY valid JSON with 4 to 5 subTopics.`;
      ...
      console.warn("Gemini API call failed for Step 1, using detailed fallback:", err);
    }
  }

  // Real, subject-tailored fallback for SQL / DBMS
  ...
  // Real fallback for Operating Systems / Computer Networks / General CS
  return {
    subTopics: [
      {
        id: 1,
