      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 glass-card p-8 rounded-3xl border border-slate-700/80 relative overflow-hidden">
        ...
        <div className="flex items-center gap-5">
          <img
            ...
            className="w-20 h-20 rounded-2xl bg-slate-900 border-2 border-emerald-500 shadow-emerald-glow p-1 shrink-0"
          />
        ...
        {/* Quick Stats Banner */}
        <div className="grid grid-cols-3 gap-4 bg-slate-900 p-4 rounded-2xl border border-slate-700">
      ...
      <div className="glass-card p-6 rounded-3xl border border-slate-700/80 space-y-6">
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="border-b border-slate-700 text-[11px] uppercase font-bold text-slate-400 tracking-wider">
                <th className="py-3 px-4">Topic & Subject</th>
                <th className="py-3 px-4">Level</th>
                <th className="py-3 px-4">Stage 2 Score</th>
            ...
            <tbody className="divide-y divide-slate-700/60 text-xs">
              {completedTopics.map((record) => (
                <tr key={record.id} className="hover:bg-slate-750 transition">
                  <td className="py-4 px-4 font-bold text-white max-w-xs">
                    {record.topic}
                  </td>
                  <td className="py-4 px-4">
                    <span className="px-2.5 py-1 rounded-md bg-slate-900 text-slate-300 font-semibold border border-slate-700">
                      {record.level}
                    </span>
                  </td>
